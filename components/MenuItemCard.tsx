            ...
            <div className="p-4 flex flex-col flex-grow relative z-10">
                ...
                <div className="flex justify-between items-center mt-auto pt-3 border-t border-slate-100">
                     <div className="flex items-center gap-2">
                        <span className="text-slate-600 text-xs font-medium bg-slate-100 px-2 py-1 rounded-md">{item.category}</span>
                        <span className="text-red-500 text-xs font-medium bg-red-500/10 px-2 py-1 rounded-md">{item.subCategory}</span>
                     </div>
